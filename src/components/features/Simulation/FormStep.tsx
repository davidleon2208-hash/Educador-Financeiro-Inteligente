...
export function FormStep({ icon: Icon, title, question, inputProps }: FormStepProps) {
  return (
    <div className="bg-card rounded-2xl p-6 shadow[4px_4px_8px_rgba(0,0,0,0.2)] sm:p-8">
